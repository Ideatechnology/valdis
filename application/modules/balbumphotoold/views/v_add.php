...
<div class="box-title">
 ...
 <div class="box-content">
								...
								<?php echo form_open('balbumphoto/submit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
                                    ...
                                    <div class="control-group">
											...
											<div class="controls">
												<input type="text" name="albumphoto_name" id="albumphoto_name" class="input-large" data-rule-required="true">
