...
<div class="box-title">
 ...
 <div class="box-content">
								...
								<?php echo form_open('balbumphoto/submiteditimage',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
									...
									<div class="control-group">
											...
											<div class="controls">
												<input type="hidden" name="id_albumphoto" id="id_albumphoto" value="<?php echo $id_albumphoto; ?>"> 
                                                <input type="text" name="albumphoto_gallery_name" id="albumphoto_gallery_name" class="input-xxlarge" data-rule-required="true" value=""> 
									    ...
									    <div class="controls">
										<textarea name="albumphoto_gallery_desc" rows="3" style="width:500px;"></textarea>
										</div>
										</div>
										...
										<li>
											...
											<div class="extras">
												<div class="extras-inner">
													...
													<a title="" rel="tooltip" class="btn btn-mini btn-danger" href="<?php echo site_url('balbumphoto/submithapusimage/'.$row['id_albumphoto_gallery'].'/'.$row['id_albumphoto']);?>" onclick="return confirm('Anda Yakin ingin Menghapus?'); "><i class="icon-delete"></i> Delete</a>                            
                            &nbsp;
                            
                            <?php if ($row['publish']=="Y") { ?>
                                          <a title="" rel="tooltip" class="btn btn-mini btn-success" href="<?php echo site_url('balbumphoto/submitpublishimage/'.$row['id_albumphoto_gallery'].'/'.$row['id_albumphoto'].'/'.'N');?>" onclick="return confirm('Not Publish?'); "><i class="icon-delete"></i>Unpublish</a> <?php } else { ?>
                   
                   <a title="" rel="tooltip" class="btn btn-mini btn-success" href="<?php echo site_url('balbumphoto/submitpublishimage/'.$row['id_albumphoto_gallery'].'/'.$row['id_albumphoto'].'/'.'Y');?>" onclick="return confirm('Publish?'); "><i class="icon-delete"></i>Publish</a> 
