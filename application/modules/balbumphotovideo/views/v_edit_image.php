				   ...
				   $the ='';	
									...
									?>
										<li>
											...
											<?php if ($row['type']=="0") { ?>
											<a href="#">
												<img alt="" src="<?=base_url()?>uploads/albumphotovideo/<?php echo $the; ?>">
											</a>
											<?php } else { ?>
											...
											<div class="extras">
												<div class="extras-inner">
													...
													<?php if ($row['type']=="0") { ?>
													<a rel="group-1" class="colorbox-image cboxElement" href="<?=base_url()?>uploads/albumphotovideo/<?php echo $the; ?>">
