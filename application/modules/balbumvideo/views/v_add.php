...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Add Gallery Video </h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('balbumvideo/submit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
                                    ...
                                    <div class="control-group">
											...
											<div class="controls">
												<input type="text" name="albumvideo_name" id="albumvideo_name" class="input-large" data-rule-required="true">
										...
										<textarea name="albumvideo_desc" class='ckeditor span12' rows="7"></textarea>
