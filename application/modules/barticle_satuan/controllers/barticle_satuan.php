...
class Barticle_satuan extends CI_Controller {

	function Barticle_satuan(){
		parent::__construct();
	...
	public function index( $offset = 0 ) {
			...
			$per_page = 20;  
			$qry = "select b.* from  news b where b.category=2 and b.sys_user_name='".$this->session->userdata('sys_user_name')."'";
			...
			$config['base_url']= base_url().'/barticle_satuan/index'; 
...
try
{
 ...
 'create_author' => $this->session->userdata('s_sys_name'),'sys_user_name' => $this->session->userdata('sys_user_name'),
