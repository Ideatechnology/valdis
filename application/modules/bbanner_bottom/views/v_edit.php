...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Edit Link Satuan</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('bbanner_bottom/submitedit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
				  ...
				  $the = $data[0]."_thumb.".$data[1];	
				   ...
				   $the ='';	
									...
									?>
										...
										<div class="controls">
											<input type="file" name="userfile"  />(File Type Allowed : Jpg,Jpeg,Png / Max.File Size 500kb / Width=82px (2,89 cm) Height=80px (2,82 cm)
