...
class Bbanner_side extends CI_Controller {

	function Bbanner_side(){
		parent::__construct();
	...
	public function index()
	{
		...
		$sql = "select b.* from  banner b where b.category=2 order by b.id_banner desc";
...
try
{
 ...
 'create_author' => $this->session->userdata('s_sys_name'),
		   ...
		   $this->load->library('image_lib');
		    #TIpe File Upload
			$attachment='';
 			$config['upload_path'] = './uploads/banner_side/';
