...
class Bbanner_top extends CI_Controller {

	function Bbanner_top(){
		parent::__construct();
	...
	public function index()
	{
		...
		$sql = "select b.* from  banner b where b.category=1 order by b.id_banner desc";
...
$this->db->query("UPDATE banner set publish='N' where category=1");
 ...
 'create_author' => $this->session->userdata('s_sys_name'),
		   ...
		   $this->load->library('image_lib');
		    #TIpe File Upload
			$attachment='';
 			$config['upload_path'] = './uploads/banner_top/';
