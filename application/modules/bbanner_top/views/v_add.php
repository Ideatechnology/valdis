...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Add Top Banner</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('bbanner_top/submit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
                                    ...
                                    <div class="control-group">
                                     ...
                                     <div class="control-group">
										...
										<div class="controls">
											<input type="file" name="userfile"  data-rule-required="true"/> (File Type Allowed : Jpg,Jpeg,Png / Max.File Size 500kb / Width=1170px (16,25 cm) Height=131px (1,82 cm)
										</div>
									</div>
