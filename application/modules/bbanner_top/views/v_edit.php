...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Edit Top Banner</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('bbanner_top/submitedit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
									...
									<div class="controls">
										...
										<textarea name="banner_desc" class='ckeditor span12' rows="7"><?php echo $banner_desc; ?></textarea>
                                    		...
                                    		<div class="control-group">
										<label class="control-label" for="textfield">Publish and Set Active</label>
				  ...
				  $the = $data[0]."_thumb.".$data[1];	
				   ...
				   $the ='';	
									...
									?>
										...
										<div class="controls">
											<input type="file" name="userfile"  />(File Type Allowed : Jpg,Jpeg,Png / Max.File Size 500kb / Width=1170px (16,25 cm) Height=131px (1,82 cm)
									...
									<div class="form-actions">
                                        ...
                                        <a class="btn btn-danger"  href="<?php echo site_url();?>bbanner_top/">Back</a>
