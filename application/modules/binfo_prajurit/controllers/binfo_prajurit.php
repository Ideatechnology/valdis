...
class Binfo_prajurit extends CI_Controller {

	function Binfo_prajurit(){
		parent::__construct();
	...
	public function index( $offset = 0 ) {
			...
			$per_page = 20;  
			$qry = "select b.* from  news b where b.category=3";
			...
			$config['base_url']= base_url().'/binfo_prajurit/index'; 
...
try
{
 ...
 'create_author' => $this->session->userdata('s_sys_name'),
		   ...
		   $this->load->library('image_lib');
		    #TIpe File Upload
			$attachment='';
 			$config['upload_path'] = './uploads/info_prajurit/';
