...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Add Info Prajurit</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('binfo_prajurit/submit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
