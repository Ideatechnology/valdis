...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Edit Berita Luar</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('bnews_luar/submitedit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
				   ...
				   $the ='';	
									...
									?>
										...
										<div class="controls">
											...
											<img src="<?=base_url()?>uploads/news_luar/<?php echo $the; ?>" alt=""> 
										</div>
									</div>
