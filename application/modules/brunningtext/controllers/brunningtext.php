...
class Brunningtext extends CI_Controller {

	function Brunningtext(){
		parent::__construct();
	...
	public function index( $offset = 0 ) {
			...
			$per_page = 20;  
			$qry = "select b.* from  news b where b.category=5";
			...
			$config['base_url']= base_url().'/brunningtext/index'; 
