...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Edit Running Text</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('brunningtext/submitedit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
				   ...
				   $the ='';	
									...
									?>
										...
										<div class="controls">
											...
											<img src="<?=base_url()?>uploads/runningtext/<?php echo $the; ?>" alt=""> 
										</div>
									</div>
                             ...
                             -->       
									...
									<div class="form-actions">
                                        ...
                                        <a class="btn btn-danger"  href="<?php echo site_url();?>brunningtext/">Back</a>
