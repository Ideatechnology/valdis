...
class Bsiaran_pers extends CI_Controller {

	function Bsiaran_pers(){
		parent::__construct();
	...
	public function index( $offset = 0 ) {
			...
			$per_page = 20;  
			$qry = "select b.* from  news b where b.category=4";
			...
			$config['base_url']= base_url().'/bsiaran_pers/index'; 
...
try
{
 ...
 'create_author' => $this->session->userdata('s_sys_name'),
		   ...
		   $this->load->library('image_lib');
		    #TIpe File Upload
			$attachment='';
 			$config['upload_path'] = './uploads/siaran_pers/';
