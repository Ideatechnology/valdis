...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Add Top Image Slide Show</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('bslider/submit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
									...
									<div class="control-group">
                                     ...
                                     <div class="control-group">
										...
										<div class="controls">
											...
											(File Type Allowed : Jpg,Jpeg,Png / Max.File Size 800kb / Width=1170px (41,28 cm) Height=505px (17,82 cm)
										</div>
									</div>
