...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Edit Top Image Slide Show</h3>
								<div class="actions">
								...
								<?php echo form_open('bslider/submitedit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
									...
									<div class="control-group">
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												<input type="text" name="sort_number" id="sort_number" class="input-xxlarge" data-rule-required="true" data-rule-number="true" value="<?php echo $sort_number; ?>">
				  ...
				  $the = $data[0]."_thumb.".$data[1];	
				   ...
				   $the ='';	
									...
									?>
										...
										<div class="controls">
											<input type="file" name="userfile"  />(File Type Allowed : Jpg,Jpeg,Png / Max.File Size 800kb / Width=1170px (41,28 cm) Height=505px (17,82 cm)
