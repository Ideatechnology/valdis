...
<div class="box-title">
 ...
 <div class="box-content">
								...
								<?php echo form_open('image_library/submitedit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
                                    ...
                                    <?php #echo $id_image_library; ?>
                                    
                                    <input type="hidden" name="id_image_library" id="id_image_library" class="input-large" data-rule-required="true" value="<?php echo $id_image_library; ?>"> 
									...
									<div class="control-group">
											...
											<div class="controls">
                                                ...
                                                <input type="text" name="image_library_name" id="image_library_name" class="input-xxlarge" data-rule-required="true" value="<?php echo $image_library_name; ?>"> 
									...
									<!--
										...
										<textarea name="image_library_desc" class='ckeditor span12' rows="7"><?php echo $image_library_desc; ?></textarea>
				   ...
				   $the ='';	
									...
									?>
										...
										<div class="controls">
											...
											<img src="<?=base_url()?>uploads/image_library/<?php echo $the; ?>" alt="">
										</div>
									</div>
