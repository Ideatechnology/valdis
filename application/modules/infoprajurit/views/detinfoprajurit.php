...
$berita_populerx="Popular Soldier Info";
$selanjutnyax="More";
} else {
$berita_lainnyax="Arsip & Info prajurit Lainnya";
$berita_populerx="Info prajurit Populer";
...
<div align="justify">
 <?php if  ($field['file_foto']) { ?>
			<img src="<?php echo base_url();?>uploads/info_prajurit/<?php echo $field['file_foto']; ?>" width="400" height="200" hspace="5" vspace="5" align="left" class="img-responsive">
            <?php } else { ?>  
			<img src="<?php echo base_url();?>uploads/info_prajurit/no_images.png" width="400" height="200" hspace="5" vspace="5" align="left" class="img-responsive">
			<?php } ?>
