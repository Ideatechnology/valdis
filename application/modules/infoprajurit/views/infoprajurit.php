...
$berita_populerx="Popular Info prajurit";
$selanjutnyax="More";
} else {
$berita_lainnyax="Arsip & Info prajurit Lainnya";
...
<?php foreach($infoprajurit as $news2) { ?>
...
<span style="color:#a4c656">
 ...
 <?php if  ($news2['file_foto']) { ?>
			<img src="<?php echo base_url();?>uploads/info_prajurit/<?php echo $news2['file_foto']; ?>"  style="width:300px; height:200px;" hspace="5" vspace="5" align="left">
            <?php } else { ?>  
			<img src="<?php echo base_url();?>uploads/info_prajurit/no_images.png" style="width:300px; height:200px;" hspace="5" vspace="5" align="left">
			<?php } ?>
												<?php 
