...
<div align="justify">
 <?php if  ($field['file_foto']) { ?>
			<img src="<?php echo base_url();?>uploads/news/<?php echo $field['file_foto']; ?>" width="400" height="200" hspace="5" vspace="5" align="left" class="img-responsive">
            <?php } else { ?>  
			<img src="<?php echo base_url();?>uploads/news/no_images.png" width="400" height="200" hspace="5" vspace="5" align="left" class="img-responsive">
			<?php } ?>
