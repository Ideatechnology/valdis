...
<div class="col-lg-12" >
				...
				<?php				
								...
								{
							?><img src="<?php echo base_url();?>assets_frontend_revisi/label/label_maluku_bersama.png" class="img-responsive">  <?php } 
								elseif ($this->session->userdata('sesi_bahasa')=="eng")
								{
						?><img src="<?php echo base_url();?>assets_frontend_revisi/label/label_ers_eng.png" class="img-responsive"> <?php
								}
								else 
								{
									?><img src="<?php echo base_url();?>assets_frontend_revisi/label/label_maluku_bersama.png" class="img-responsive"> <?php
...
<img src="<?php echo base_url()?>assets_frontend/images/visimisi/Visi%20Misi.jpg" class="img-responsive"> 
