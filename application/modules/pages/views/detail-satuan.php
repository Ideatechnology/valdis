...
<div class="col-lg-12" >
				...
				<?php				
								...
								{
							?><img src="<?php echo base_url();?>assets_frontend_revisi/label/label_satuan.png" class="img-responsive">  <?php } 
								elseif ($this->session->userdata('sesi_bahasa')=="eng")
								{
						?><img src="<?php echo base_url();?>assets_frontend_revisi/label/label_satuan_eng.png" class="img-responsive"> <?php
								}
								else 
								{
									?><img src="<?php echo base_url();?>assets_frontend_revisi/label/label_satuan.png" class="img-responsive"> <?php
