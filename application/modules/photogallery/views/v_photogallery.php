       ...
       <div class = "row">
		...
		<?php				
								...
								{ ?> <img style="" src="<?php echo base_url()?>assets_frontend/images/siaran_pers/header_galeri.png" alt="">  <?php } 
								elseif ($this->session->userdata('sesi_bahasa')=="eng")
								{
						?> <img style="" src="<?php echo base_url()?>assets_frontend/images/siaran_pers/label_eng.png" alt=""> <?php
								}
								else 
								{
									?><img style="" src="<?php echo base_url()?>assets_frontend/images/siaran_pers/header_galeri.png" alt=""> <?php
...
if ($this->session->userdata('sesi_bahasa')=="ind") 
		...
		<?php 
		$sqlalbum = "select  * from albumphoto_gallery where id_albumphoto= '".$id_albumphoto."' order by create_time desc";
		$album=$this->db->query($sqlalbum)->row();
		?>
...
if ($this->session->userdata('sesi_bahasa')=="ind") 
							...
							echo  $albumphoto_name;
								...
								elseif ($this->session->userdata('sesi_bahasa')=="eng")
								{
							echo		"inggris";//$albumphoto_name_eng;
								}
								else 
								{
								echo	$albumphoto_name;
		...
		if ($this->session->userdata('sesi_bahasa')=="ind") 
								...
								elseif ($this->session->userdata('sesi_bahasa')=="eng")
								{ echo	"Deskripsi inggris"; }//$albumphoto_desc_eng; }
								else 
								{ echo	$albumphoto_desc;}
